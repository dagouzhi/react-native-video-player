...
class VideoPlayer extends React.Component {
    constructor(props) {
        ...
        this.animatedDot = (e) => {
            ...
            {
                toValue: e.playableDuration,
                duration: 0,
                useNativeDriver: false
            }).start(); // 开始执行动画
        };
        this.speedLongTouch = (evt) => {
        ...
        //重置播放
        this.rePlay = (autoPlay = true, admRePlay = true) => {
    ...
    componentWillMount() {
                ...
                if (this.recordHandeY.length === 10) {
                    if (Math.abs(this.recordHandeY[9] - this.recordHandeY[0]) > Math.abs(this.recordHandeX[9] - this.recordHandeX[0])) {
                        ...
                        if (this.state.onload && Math.abs(this.moveXData) > 0) {
                            ...
                            this.SpeedTipTimeRef && this.SpeedTipTimeRef.setgoSpeedTime(formatSeconds(this.speedalltime));
        ...
        this._panSpeeDot = PanResponder.create({
            ...
            onPanResponderGrant: (evt, gestureState) => {
                ...
                if (this.state.showOpenVip || !this.state.onload)
                    return; //需要权限 或者视频还不可以播放时停止不允许滑动进度条
            ...
            React.createElement(View, { ref: ref => this.videoBox = ref, style: { backgroundColor: "#000", position: 'relative' } },
                React.createElement(View, { style: {} },
                    React.createElement(View, Object.assign({}, this._panResponder.panHandlers, { style: { height: stateHeight, width: stateWidth, }, activeOpacity: 1 }),
                        React.createElement(TouchableOpacity, { activeOpacity: 1, onPress: this.showConts, onLongPress: this.speedLongTouch, onPressOut: this.speedLongTouchOut, style: { overflow: "hidden" } },
                            ...
                            React.createElement(View, { style: { position: 'absolute', left: 0, right: 0, bottom: 0, top: 0, flexDirection: "row", justifyContent: 'space-between', } },
                                React.createElement(View, { ref: (e) => this.leftSpeedRef = e, style: { opacity: 0, width: stateHeight * 2, backgroundColor: "rgba(0,0,0,0.5)", borderRadius: stateHeight * 2, right: stateHeight * 2 - speedLoToWidth, height: stateHeight * 2, top: -stateHeight / 2 } }),
                                React.createElement(View, { ref: (e) => this.rightSpeedRef = e, style: { opacity: 0, width: stateHeight * 2, backgroundColor: "rgba(0,0,0,0.5)", borderRadius: stateHeight * 2, right: stateHeight * 2 - stateWidth + speedLoToWidth, height: stateHeight * 2, top: -stateHeight / 2 } }),
                                speedTouch &&
                                    React.createElement(View, { style: { position: "absolute", top: topContsTop + 20, width: stateWidth, alignItems: "center" } },
                                        React.createElement(View, { style: { justifyContent: 'center', flexDirection: 'row', backgroundColor: "rgba(0,0,0,0.6)", paddingVertical: 4, paddingHorizontal: 8, borderRadius: 4 } },
                                            React.createElement(AnFastSvg, { isSolTouch: this.isSolTouch, videoRate: videoRate, solText: this.props.solText, fastText: this.props.fastText })))))),
                    this.state.showConts ?
                        React.createElement(Animated.View, { style: { position: "absolute", left: 0, right: 0, top: 0, opacity: this.state.opacity, height: 30 } },
                            React.createElement(LinearGradient, { colors: ['rgba(0,0,0,0.4)', 'rgba(0,0,0,0.1)', 'rgba(0,0,0,0)'], style: { height: LinearGradientHeight, width: stateWidth } }),
                            preShowSmallCont && React.createElement(TouchableOpacity, { style: { position: "absolute", top: topContsTop, left: smallP ? 5 : this.props.continuous ? 45 : 5, padding: 10, zIndex: 999, flexDirection: 'row' }, 
                                ...
                                React.createElement(SvgVideoBack, { height: "20", width: "20" }),
                                React.createElement(Text, { style: { color: "#fff", fontSize: 15, paddingLeft: 10, maxWidth: smallP ? width / 3 : height / 3, ...this.props.backVideoNameStyle }, numberOfLines: 1 }, this.props.backVideoName ? this.props.backVideoName : '')),
                    ...
                    this.props.lockControl &&
                        React.createElement(Lock, Object.assign({ ref: (ref) => this.LockRef = ref, showContsfun: (e) => { this.setState({ showConts: e }); } }, this.state)),
                    this.state.showConts &&
                        React.createElement(LinearGradient, { colors: ['rgba(0,0,0,0)', 'rgba(0,0,0,0.1)', 'rgba(0,0,0,0.4)'], style: { height: LinearGradientHeight, width: stateWidth, position: "absolute", bottom: this.state.smallP ? 0 : -bottomContsBottom } }),
                    this.state.showConts ?
                        React.createElement(Animated.View, { style: { width: stateWidth, bottom: bottomContsBottom, opacity: this.state.opacity, zIndex: 99999, position: "absolute", } },
                            React.createElement(View, { style: { flexDirection: "row", flexWrap: "nowrap" } },
                                !this.props.continuous ? (this.state.paused
                                    ?
                                        React.createElement(TouchableOpacity, { activeOpacity: 1, style: s.touchs, onPress: () => {
                                                if (!showOpenVip) {
                                                    this.rePlay(true, false);
                                                }
                                            } },
                                            React.createElement(SvgVideoPlay, { height: "20", width: "20" }))
                                    :
                                        React.createElement(TouchableOpacity, { activeOpacity: 1, style: s.touchs, onPress: this.btnPasuedfun },
                                            React.createElement(SvgVideoStop, { height: "20", width: "20" })))
                                    :
                                        smallP && (this.state.paused
                                            ...
                                            :
                                                React.createElement(TouchableOpacity, { activeOpacity: 1, style: s.touchs, onPress: this.btnPasuedfun },
                                                    React.createElement(SvgVideoStop, { height: "20", width: "20" }))),
                                React.createElement(Speed, Object.assign({}, this.state, { color: this.props.speedColor, cachColor: this.props.cachColor, dotColor: this.props.dotColor, dotBorderColor: this.props.dotBorderColor, allSpeedColor: this.props.allSpeedColor, admRePlay: this.state.admRePlay, nowTime: this.nowTime, panHandlers: this._panSpeeDot.panHandlers, allTime: allTime, ref: child => this.dotspeed = child, playDotX: this.playDotX, playBufferX: this.playBufferX, ismoveDot: this.ismoveDot })),
                                this.state.smallP ?
                                    React.createElement(TouchableOpacity, { activeOpacity: 0.5, style: { padding: 10, width: 40, bottom: 0, right: 5, zIndex: 9999, alignSelf: "flex-end", justifyContent: "flex-end" }, onPress: () => { this.changeAllBox(); } },
                                        React.createElement(SvgVideoAllBox, { height: "20", width: "20" }))
                                    : (!this.props.continuous &&
                                        React.createElement(TouchableOpacity, { activeOpacity: 0.5, style: { padding: 10, width: 40, bottom: 0, right: 5, zIndex: 9999, alignSelf: "flex-end" }, onPress: () => { this.changeSmallBox(); } },
                                            React.createElement(SvgVideoSmallBox, { height: "20", width: "20" })))),
                            !smallP &&
                                React.createElement(View, { style: { height: 40, width: stateWidth, paddingHorizontal: 45, flexDirection: "row" } },
                                        ...
                                        this.props.continuous && (this.state.paused
                                            ?
                                                React.createElement(TouchableOpacity, { activeOpacity: 1, style: s.touchs, onPress: () => {
                                                    ...
                                                    React.createElement(SvgVideoPlay, { height: "20", width: "20" }))
                                            :
                                                React.createElement(TouchableOpacity, { activeOpacity: 1, style: { bottom: 0, left: 5, padding: 10, zIndex: 999 }, onPress: () => { !showOpenVip && this.setState({ paused: true }); } },
                                                    React.createElement(SvgVideoStop, { height: "20", width: "20" }))),
                                        this.props.continuous &&
                                            React.createElement(TouchableOpacity, { activeOpacity: this.props.nextBtnFun ? 0.5 : 1, style: { padding: 10, width: 40, bottom: 0, right: 5, zIndex: 9999, alignSelf: "flex-end", marginLeft: 10 }, onPress: () => { this.props.nextBtnFun && this.props.nextBtnFun(); } },
                                                React.createElement(SvgVideoNextBtn, { height: "20", width: "22", fill: this.props.nextBtnFun ? "#ffffff" : "#626262" }))),
                                    React.createElement(View, { style: { flexDirection: "row", flex: 1, justifyContent: "flex-end" } },
                                        this.props.continuous &&
                                            React.createElement(TouchableOpacity, { activeOpacity: 0.5, style: { padding: 10, bottom: 0, right: 5, zIndex: 9999, alignSelf: "flex-end" }, onPress: () => { this.setState({ showConts: false, showChangeList: true, showLockCont: false }); } },
                                                React.createElement(Text, { style: { color: "#fff" } }, "\u9009\u96C6")),
                                        this.props.continuous &&
                                            React.createElement(TouchableOpacity, { activeOpacity: 0.5, style: { padding: 10, width: 40, bottom: 0, right: 5, zIndex: 9999, alignSelf: "flex-end" }, onPress: () => { this.changeSmallBox(); } },
                                                React.createElement(SvgVideoSmallBox, { height: "20", width: "20" })))))
                        :
                            null),
                React.createElement(SpeedTipTime, Object.assign({ ref: (ref) => this.SpeedTipTimeRef = ref }, this.state, { allTime: allTime })),
                /* loading */
                React.createElement(Loading, Object.assign({}, this.state, { spin: spin, loadingText: this.props.loadingText, loadingIcon: this.props.loadingIcon })),
                this.adminPaused && this.state.paused && React.createElement(TipsPaused, Object.assign({}, this.state, { pausedTipText: this.props.pausedTipText })),
                this.state.showVolume ?
                    React.createElement(Volume, Object.assign({ ref: (ref) => this.VolumeRef = ref }, this.state))
                    :
                        null,
                this.state.showBrightness ?
                    React.createElement(Brightness, Object.assign({ ref: (ref) => this.BrightnessRef = ref }, this.state))
                    :
                        null,
